# =============================================================================
# NVFP4 Dual-GEMM Submission - Overlapped Streams
# =============================================================================
# GPU MODE Leaderboard Submission
# Kernel: C = silu(A @ B1) * (A @ B2)
# Target: NVIDIA B200 (SM100 Blackwell)
#
# Uses CUDA streams to overlap the two independent GEMMs
# =============================================================================
...
def custom_kernel(data: input_t) -> output_t:
    """
    NVFP4 dual GEMM with overlapped CUDA streams.

    Runs the two independent GEMMs on separate streams for potential overlap.
    """
    ...
    if l == 1:
        ...
        # Launch both GEMMs on separate streams
